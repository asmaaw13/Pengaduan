...
class BerandaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "SMART RESCUE!"
    }
...
//            cells[j].column.alignment = Element.ALIGN_CENTER
        ...
        paragraph1 = Paragraph("PEMERINTAH KOTA PEKANBARU \n", f)
        paragraph2 = Paragraph("KEL. UMBAN SARI ATAS KEC. RUMBAI \n", g)
        paragraph3 = Paragraph("Jalan Patin No. 1 \n\n", h)
